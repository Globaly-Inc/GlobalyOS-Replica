...
<img src="${GLOBALYOS_LOGO_URL}" alt="GlobalyOS" style="width: 48px; height: 48px; border-radius: 10px;" />
<h1 style="color: #1e293b; margin: 12px 0 4px 0; font-size: 20px; font-weight: 600;">${title}</h1>
