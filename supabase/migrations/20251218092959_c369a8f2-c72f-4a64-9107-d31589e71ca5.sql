-- Drop all existing overloaded versions of record_remote_attendance
DROP FUNCTION IF EXISTS public.record_remote_attendance(text, numeric, numeric);
DROP FUNCTION IF EXISTS public.record_remote_attendance(text, numeric, numeric, text);
