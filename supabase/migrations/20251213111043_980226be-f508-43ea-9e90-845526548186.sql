-- Add location fields to office_qr_codes table
ALTER TABLE public.office_qr_codes
ADD COLUMN latitude numeric NULL,
ADD COLUMN longitude numeric NULL,
ADD COLUMN radius_meters integer NULL DEFAULT 100;

-- Update the validate_qr_and_record_attendance function to include location validation
...
BEGIN
  ...
  SELECT office_id, organization_id, latitude, longitude, radius_meters 
  INTO v_office_id, v_qr_org_id, v_qr_latitude, v_qr_longitude, v_qr_radius
