-- ============================================
-- Update Employee Activity Timeline RPC
-- Filter out chat_sent, chat_created, wiki_updated events
-- ============================================
...
BEGIN
  ...
  all_events AS (
    ...
    -- User activity logs (attendance, documents, etc.)
    -- Excludes: chat_sent, chat_created, wiki_updated (these have their own modules)
    SELECT 
      ual.id,
      ual.activity_type,
      CASE 
