  ...
  public: {
    Tables: {
      ...
      crm_service_categories: {
        ...
        Relationships: [
          {
            foreignKeyName: "crm_service_categories_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
      ...
      task_favorites: {
        ...
        Relationships: [
          {
            foreignKeyName: "task_favorites_employee_id_fkey"
            columns: ["employee_id"]
            isOneToOne: false
            referencedRelation: "employee_directory"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "task_favorites_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      ensure_crm_service_categories_defaults: {
