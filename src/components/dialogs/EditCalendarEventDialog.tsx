...
const EditCalendarEventDialog = ({
  ...
  const onSubmit = async (values: FormValues) => {
    ...
    try {
      ...
      // Delete existing office associations
      ...
      // Insert new office associations if not applying to all
...
export default EditCalendarEventDialog;
