...
export const AddLearningDialog = ({
  employeeId
  ...
  const mutation = useMutation({
    mutationFn: async (values: z.infer<typeof formSchema>) => {
      const {
        data,
        error
      } = await supabase.from("learning_development").insert({
    ...
    onSuccess: () => {
      ...
      toast.success("Learning record added successfully");
      setOpen(false);
      form.reset();
    },
    onError: (error: Error) => {
      toast.error(`Failed to add learning record: ${error.message}`);
    }
  });
  ...
  return <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>Add Learning & Development Record</DialogTitle>
        </DialogHeader>
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            ...
            field
                  ...
                  <FormControl>
                    <Input placeholder="e.g., Amazon Web Services, Coursera" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>} />
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <FormField control={form.control} name="expiry_date" render={({
              field
            }) => <FormItem>
            ...
            field
                  ...
                  <FormControl>
                    <Textarea placeholder="Additional details about this learning activity..." className="min-h-[100px]" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>} />
