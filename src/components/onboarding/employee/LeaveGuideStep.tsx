...
import { ArrowRight, ArrowLeft, Calendar, FileText, UserCheck, Clock, CalendarDays, Loader2 } from 'lucide-react';
...
export function LeaveGuideStep({ onContinue, onBack, isNavigating = false }: LeaveGuideStepProps) {
  return (
