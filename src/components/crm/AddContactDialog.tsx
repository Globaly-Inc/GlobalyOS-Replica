...
import { useCreateCRMContact } from '@/services/useCRM';
import { useCRMCompanies } from '@/services/useCRM';
...
export const AddContactDialog = ({ open, onOpenChange }: Props) => {
    ...
    createMutation.mutate(
      ...
      },
      {
        onSuccess: () => {
          ...
          onOpenChange(false);
          setForm({ first_name: '', last_name: '', email: '', phone: '', job_title: '', company_id: '', rating: '', source: '', notes: '' });
        },
