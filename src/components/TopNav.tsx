  ...
  return (
    <nav className="flex items-center space-x-0.5 tour-feature-overview">
      ...
      <OrgLink
        key={item.name}
        to={item.href}
        className={cn("rounded-lg px-3 py-2 text-sm font-medium text-muted-foreground transition-colors hover:bg-secondary hover:text-foreground gap-[10px] flex items-center justify-start",
