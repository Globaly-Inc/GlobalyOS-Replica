              ...
              <Routes>
                ...
                <Route path="/org/:orgCode">
                  ...
                  <Route path="tasks" element={<OrgProtectedRoute><FeatureProtectedRoute feature="tasks"><Tasks /></FeatureProtectedRoute></OrgProtectedRoute>} />
                   ...
                   <Route path="crm/calls/numbers/:phoneId/ivr" element={<OrgProtectedRoute><FeatureProtectedRoute feature="crm"><FeatureProtectedRoute feature="telephony"><IvrBuilderPage /></FeatureProtectedRoute></FeatureProtectedRoute></OrgProtectedRoute>} />
